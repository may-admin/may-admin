...
<head>
    ...
    <style>
        ...
        .exception .page_404{text-align:center;margin-top:170px;}
        .exception .title{font-size: 80px;font-family: arial;font-weight: bold;}
        .exception .desc{font-size: 16px;}
...
<body>
    ...
    <?php } else { ?>
    <div class="exception">
        <div class="info"><?php echo htmlspecialchars_decode($message); ?></div>
    </div>
    <?php } ?>
    ...
    <div class="copyright" <?php if (\think\facade\App::isDebug()) {}else{echo "style='display:none'";} ?> >

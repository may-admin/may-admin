...
class Radio
{
    ...
    public function index($data, $wconfig)
    {
        ...
        if ( !isset($wconfig['from']) || ($wconfig['from'] != 'selectlist' && $wconfig['from'] != 'function') ){
            return '<div class="form-group"><label class="col-sm-'.$wconfig['title_col'].' control-label">'.$wconfig['title'].'</label><div class="col-sm-'.$wconfig['content_col'].'"><span class="help-block">radio来源 from 必须是 selectlist 或 function</span></div></div>';
        }

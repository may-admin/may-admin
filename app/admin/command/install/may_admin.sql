...
(1, 'admin', 49, '超级管理员', 1, '1,2,12,17,18,19,20,21,22,13,14,15,16,23,24,25,26,3,4,8,9,10,11,27,28,29,30,31', '该角色不可删除，需要分配全部权限节点', 1699178086, 1699178086),
(2, 'admin', 48, '普通管理员', 1, '', '需要分配相应权限进行操作', 1699178086, 1699178086);
...
(2, 1, 'admin', 2, 'Index/cleanCache', '清除缓存', 1, 1, 0, NULL, '', 48, 1699178086, 1721356174),
(3, 0, 'admin', 1, 'leftSystem', '系统管理', 1, 1, 1, NULL, 'fa-solid fa-gear', 100, 1699178086, 1746774497),
(4, 3, 'admin', 2, 'Config/index', '系统配置字段', 1, 1, 1, NULL, 'fa-solid fa-gears', 47, 1699178086, 1746774553),
(8, 4, 'admin', 3, 'Config/create', '新增', 1, 1, 0, NULL, '', 49, 1699178086, 1746774674),
(9, 4, 'admin', 3, 'Config/edit', '编辑', 1, 1, 0, NULL, '', 48, 1699178086, 1746774673),
(10, 4, 'admin', 3, 'Config/delete', '删除', 1, 1, 0, NULL, '', 47, 1699178086, 1746774671),
(11, 4, 'admin', 3, 'Config/save', '保存', 1, 1, 0, NULL, '', 46, 1699178086, 1746774669),
(12, 0, 'admin', 1, 'leftAdmin', '管理员管理', 1, 1, 1, NULL, 'fa-solid fa-users', 300, 1699178086, 1727623868),
(13, 12, 'admin', 2, 'AuthRule/index', '节点列表', 1, 1, 1, NULL, 'fa-solid fa-pen-ruler', 48, 1699178086, 1727624017),
(14, 13, 'admin', 3, 'AuthRule/create', '新增', 1, 1, 0, NULL, '', 49, 1699178086, 1746774655),
(15, 13, 'admin', 3, 'AuthRule/edit', '编辑', 1, 1, 0, NULL, '', 48, 1699178086, 1699178454),
(16, 13, 'admin', 3, 'AuthRule/delete', '删除', 1, 1, 0, NULL, '', 47, 1699178086, 1746774653),
(17, 12, 'admin', 2, 'Admin/index', '管理员列表', 1, 1, 1, NULL, 'fa-solid fa-user-tie', 49, 1699178086, 1746774533),
(18, 17, 'admin', 3, 'Admin/create', '新增', 1, 1, 0, NULL, '', 49, 1699178086, 1746774643),
(19, 17, 'admin', 3, 'Admin/edit', '编辑', 1, 1, 0, NULL, '', 48, 1699178086, 1746774641),
(20, 17, 'admin', 3, 'Admin/delete', '删除', 1, 1, 0, NULL, '', 47, 1699178086, 1699178444),
(21, 17, 'admin', 3, 'Admin/authGroup', '授权角色', 1, 1, 0, NULL, '', 46, 1699178086, 1746774638),
(22, 1, 'admin', 2, 'Admin/editSelf', '个人资料', 1, 1, 0, NULL, '', 49, 1699178086, 1746774636),
(23, 12, 'admin', 2, 'AuthGroup/index', '角色列表', 1, 1, 1, NULL, 'fa-solid fa-address-card', 47, 1699178086, 1746774604),
(24, 23, 'admin', 3, 'AuthGroup/create', '新增', 1, 1, 0, NULL, '', 49, 1699178086, 1746774663),
(25, 23, 'admin', 3, 'AuthGroup/edit', '编辑', 1, 1, 0, NULL, '', 48, 1699178086, 1699178469),
(26, 23, 'admin', 3, 'AuthGroup/delete', '删除', 1, 1, 0, NULL, '', 47, 1699178086, 1746774661),
(27, 3, 'admin', 2, 'Config/sysMenu', '系统配置', 1, 1, 1, NULL, 'fa-solid fa-gear', 48, 1699178086, 1731396901),
(28, 27, 'admin', 3, 'Config/sys', '后台配置', 1, 1, 0, NULL, '', 49, 1699178086, 1746774569),
(29, 27, 'admin', 3, 'Config/up', '上传配置', 1, 1, 0, NULL, '', 48, 1699178086, 1746774571),
(30, 3, 'admin', 2, 'UploadFile/index', '附件列表', 1, 1, 1, NULL, 'fa-regular fa-file', 49, 1728830498, 1746774549),
(31, 30, 'admin', 3, 'UploadFile/delete', '删除', 1, 1, 0, NULL, NULL, 49, 1728830758, 1746775263);
...
(1, 'upload_path', 'uploads', 'up', '文件上传目录', '文件上传根目录存放文件名', 49, 1, 'Input', '', 1699178086, 1746775511),
(2, 'upload_size', '2', 'up', '上传文件大小', '单位【MB】，最大上传限制1MB则填写数字：1', 48, 1, 'Input', '', 1699178086, 1746775509),
(3, 'image_format', 'jpg,jpeg,png', 'up', '上传图片格式', '上传图片后缀限制格式', 47, 1, 'Input', '', 1699178086, 1746775506),
(4, 'file_format', 'doc,docx,xls,xlsx,ppt,pptx,zip,rar,7z', 'up', '上传文件格式', '上传文件后缀限制格式', 46, 1, 'Input', '', 1699178086, 1746775504),
(5, 'flash_format', 'swf,flv', 'up', '上传Flash格式', '上传Flash后缀限制格式', 45, 1, 'Input', '', 1699178086, 1746775502),
(6, 'media_format', 'swf,flv,mp3,mp4,wav,wma,wmv,mid,avi,mpg,asf,rm,rmvb', 'up', '上传视音频格式', '上传视音频后缀限制格式', 44, 1, 'Input', '', 1699178086, 1730355378),
(7, 'isprint', '0', 'up', '是否开启图片水印', '是否开启图片水印', 43, 1, 'Radio', 'whether', 1699178086, 1746775498),
(8, 'print_image', '', 'up', '水印图片', '可为上传的图片添加水印【开启了图片水印功能，请必须上传水印图片】', 42, 1, 'Image', '', 1699178086, 1746775496),
(9, 'print_position', '9', 'up', '水印图片位置', '水印图片位置', 41, 1, 'Select', 'print_position', 1699178086, 1746775495),
(10, 'print_blur', '100', 'up', '水印图片透明度', '水印图片透明度，取值范围【0-100】', 40, 1, 'Input', '', 1699178086, 1746775493),
(11, 'file_url', '', 'up', '图片上传域名地址', '图片路径保存数据库是否带域名，不建议填写，除非很清楚怎么使用', 39, 1, 'Input', '', 1699178086, 1746775491),
(20, 'login_title', 'MayAdmin', 'sys', '登录显示标题', '登录显示标题', 49, 1, 'Input', '', 1699178086, 1746775453),
(21, 'top_big_logo', 'MayAdmin', 'sys', '系统顶部LOGO', '左侧菜单展开时系统顶部LOGO', 46, 1, 'Input', '', 1699178086, 1729000263),
(22, 'top_small_logo', 'May', 'sys', '系统顶部小LOGO', '左侧菜单缩进时系统顶部小LOGO', 45, 1, 'Input', '', 1699178086, 1746775430),
(23, 'copyright', 'Copyright © 2017-2025 &lt;a href=&quot;#&quot; &gt;QQ群：184278846&lt;/a&gt;', 'sys', '系统版权', '系统版权', 44, 1, 'Input', '', 1699178086, 1746775428),
(24, 'version', 'MayAdmin 1.0.0', 'sys', '系统版本号', '系统版本号', 43, 1, 'Input', '', 1699178086, 1746775427),
(28, 'login_image', 'MayAdmin后台管理', 'sys', '登录图片LOGO', '登录图片LOGO', 48, 1, 'Input', '', 1699178086, 1746775450),
(29, 'login_bg', '/static/global/common/img/avatar.png', 'sys', '登录背景图', '登录背景图', 47, 1, 'Image', '', 1699178086, 1746775448);
